...
let SpecialistsService = class SpecialistsService {
    ...
    constructor(specialistsRepository) {
    ...
    async findOne(id) {
        ...
        if (!specialist) {
            throw new common_1.NotFoundException(`Specialist #${id} not found`);
        }
        return specialist;
    }
...
exports.SpecialistsService = SpecialistsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(specialist_entity_1.Specialist)),
